...
function mintpay_display_price_breakdown_in_checkout_page(){
	...
	if( !$cart->is_empty() ){
		...
		_e('<div style="padding: 10px 0 10px 0; font-size: ' . esc_attr($mintpay_font_size) . '; color: #8e8e8e; line-height: 20px;" class=' . esc_attr($mintpay_css_classname) . '>Get Rs. 500.00 off on your first Pay Now purchase with ' . $mintpay_logo . '</div>');
	}	
}
